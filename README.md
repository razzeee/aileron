...
| `type` | string | all requests | One of `generate`, `generate_structured`, `generate_structured_stream`, `transcribe`, `describe`, `ocr`, `detect`, `segment`, `depth`, `embed` |
