...
The stub supports the container stdio request types with deterministic fake responses, including `generate`, `predict_next`, `generate_structured`, `embed`, `transcribe`, `describe`, `ocr`, and `segment`.
