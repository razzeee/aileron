...
The stub supports the container stdio request types with deterministic fake responses, including `generate`, `generate_structured`, `embed`, `transcribe`, `describe`, `ocr`, and `segment`.
