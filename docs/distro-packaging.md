...
- `xdg-desktop-portal` with the public `org.freedesktop.portal.Language`, `org.freedesktop.portal.SpokenLanguage`, and `org.freedesktop.portal.Vision` frontend interfaces for sandboxed app integration
